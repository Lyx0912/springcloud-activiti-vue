<template>
  <div class="app-container">
    <el-row style="margin-bottom: 12px">
      <el-col :span="24">
        <el-form ref="queryForm" :model="queryParams" size="small" :inline="true" style="float: left">
          <el-form-item label="申请人" prop="status">
            <el-input v-model="queryParams.uname" placeholder="请输入申请人" size="small" style="margin-right: 20px"></el-input>
          </el-form-item>&nbsp;
    ...
    >
      ...
      <el-table-column align="center" label="申请人" prop="uname" width="100" />
